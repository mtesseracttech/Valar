...
namespace mt::gfx::mtvk {
	VulkanRenderer::VulkanRenderer(const std::shared_ptr<ContextWindow>& render_window) : Renderer(render_window){
	    ...
	    command_buffer->create_command_buffers(*test_shader_pipeline, *swapchain, *render_pass);
