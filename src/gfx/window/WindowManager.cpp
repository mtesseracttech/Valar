...
void WindowManager::set_main_window(
    const std::shared_ptr<ContextWindow>& main_window)
{
    Logger::log(
        "Added Main Window: '" + main_window->get_title() + "' to Window Manager",
        Info);
...
{
    Logger::log("Added Window to Window Manager: '" + window->get_title() + "'",
        Info);
